...
Install Dependencies Navigate to the project folder and install the required Python packages:

pip install -r requirements.txt
Initialize the Database Before running the app for the first time, you need to set up the SQLite database mapping for user accounts and portfolios.
...
Access the Web App Open your preferred web browser and navigate to:
...
Sign Up / Log In: Start by creating a secure account.
Dashboard: View your total portfolio value in INR, see your individual stock allocations, and check recent performance.
Get Recommendations: Navigate to the recommendation section, input your budget and desired risk level (Low, Medium, High), and let the AI propose optimal stocks to buy based on recent sentiment and technical data.
View Trends: Check detailed dynamic stock charts to view moving averages and price changes across varying time intervals.
Manage Portfolio: Add stocks you currently own, and update their quantities/buy price to track your gains and losses effortlessly
